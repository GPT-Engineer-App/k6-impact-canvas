  ...
  return (
    <div className="min-h-screen p-8 bg-gray-100">
      ...
      <div className="max-w-4xl mx-auto">
          ...
          <Card>
            ...
            <CardContent>
              <ul className="list-disc pl-5">
                ...
                <li>Can purr and meow for communication</li>
                <li>Generally clean animals that groom themselves</li>
              </ul>
            </CardContent>
          </Card>
        ...
        <p className="text-lg">
          Whether you're a cat owner or simply an admirer, these elegant creatures continue 
          to captivate us with their mysterious and charming personalities.
        </p>
      </div>
    </div>
  );
